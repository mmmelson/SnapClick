...
最近偶然发现了[网页版的《红色警戒2》](https://game.chronodivide.com)，Mac 也能玩！组建坦克大军需要快速重复点击同一个单位，用触控板操作手指简直酸爽。😅

我试过 GitHub 上的一些连点器，要么收费要么不灵活。所以做了 SnapClick：**一个简单、稳定的鼠标连点器。**

马上开始使用，[**下载**](https://github.com/mmmelson/SnapClick/releases/latest)应用！
