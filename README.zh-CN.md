...
最近偶然发现了[《红色警戒》网页版](https://game.chronodivide.com)，瞬间沉迷。在浏览器里建设苏联战争机器，咖啡时间都变得有意义了起来 ☕️

问题来了：购买小兵、坦克的时候，我发现自己像个点钞机一样疯狂点击鼠标来批量购入或取消订单。食指都要练出腱鞘炎了！😅

试了 GitHub 上几个连点器——有的会崩溃，有的只能点左键——我心想："算了，自己写一个吧。" 于是就有了这个项目。

**SnapClick 诞生于拯救你的点击手指、征服世界的崇高使命。一个简单、稳定、功能强大的鼠标连点器。**
